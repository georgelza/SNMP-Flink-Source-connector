...
CREATE TABLE hive.snmp.snmp_poll_data1 (
    ...
    ,'snmp.version'                 = 'SNMPv1'                  -- SNMPv1, SNMPv2c or SNMPv3 
    ,'snmp.community-string'        = 'abfr24'                  -- Use if set for SNMPPv1 and SNMPv2c
    ,'snmp.poll_mode'               = 'GET'                     -- GET or WALK
    ,'oids'                         = '1.3.6.1.2.1.2.2.1.2.2'   -- 1 OIDs           
...
CREATE TABLE hive.snmp.snmp_poll_data4 (
    ...
    ,'snmp.version'                 = 'SNMPv3'                  -- If Set then username and password required in addition to auth-protocol and priv-protocol
    ,'snmp.username'                = 'snmp'                 

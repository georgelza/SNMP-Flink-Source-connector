...
public class SnmpConfigOptions {
         ...
         * Defaults to "NONE".
         */
        public static final ConfigOption<String> SNMPV3_AUTH_PROTOCOL = ConfigOptions // New option
                .key("snmp.auth-protocol")
                .stringType()
                .defaultValue("NONE")
                .withDescription("The SNMPv3 authentication protocol. Possible values: 'MD5', 'SHA', 'NONE'. Defaults to 'NONE'.");

        /**
         * The SNMPv3 privacy protocol.
         * Possible values: "DES", "AES", "AES128", "AES192", "AES256", "NONE".
         * Defaults to "NONE".
         */
        public static final ConfigOption<String> SNMPV3_PRIV_PROTOCOL = ConfigOptions // New option
                .key("snmp.priv-protocol")
                .stringType()
                .defaultValue("NONE")
                .withDescription("The SNMPv3 privacy protocol. Possible values: 'DES', 'AES', 'AES128', 'AES192', 'AES256', 'NONE'. Defaults to 'NONE'.");

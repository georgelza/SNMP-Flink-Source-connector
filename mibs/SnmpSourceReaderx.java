...
public class SnmpSourceReader implements SourceReader<RowData, SnmpSourceSplit> {
    ...
    private void processVariableBinding(VariableBinding vb) {
        ...
        // ADDED LOG STATEMENT: Log raw VariableBinding before any checks
        System.out.println(Thread.currentThread().getName() + " Raw VariableBinding received: " + (vb != null ? vb.toString() : "null") + " (Direct System.out)");
        System.out.println(Thread.currentThread().getName() + " Raw OID: " + ((vb != null && vb.getOid() != null) ? vb.getOid().toString() : "null") + " (Direct System.out)");
        System.out.println(Thread.currentThread().getName() + " Raw Variable: " + ((vb != null && vb.getVariable() != null) ? vb.getVariable().toString() : "null") + " (Direct System.out)");
